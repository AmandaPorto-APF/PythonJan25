...
# soma = a+b
# print(nome, ', a soma desses numeros e: ', soma)

#%%
#ex 2

# paragrafo1 = 'aaaaaaaaaaa'
# paragrafo2 = 'bbbbbbbbbbbb'
# paragrafo3 = 'ccccccccccc'

# print(paragrafo1)
# input('Deseja continuar? Pressione enter:')
##input() #input() vazio fica esperando o usuario dar enter
...
# raiz = int(numero ** 0.5)
##raiz = round(raiz, 2) #se no quiser inteiro, pode ser float com duas casas decimais
